...
# audio = whisper.load_audio("data/File Esperimento Whisper/Pasti_A.wav")
# model = whisper.load_model("/home/ludop/Documents/personal-whisper/models/medium.pt", device="cpu")
